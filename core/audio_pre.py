...
from core.uvr5_pack.lib_v5 import nets_61968KB as Nets
from core.uvr5_pack.lib_v5 import spec_utils
from core.uvr5_pack.lib_v5.model_param_init import ModelParameters
from core.uvr5_pack.utils import inference
...
class AudioPre:
    def __init__(self, agg, is_half=False, tta=False):
        ...
        mp = ModelParameters("core/uvr5_pack/lib_v5/modelparams/4band_v2.json")
